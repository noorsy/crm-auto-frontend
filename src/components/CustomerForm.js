  ...
  useEffect(() => {
    if (customer) {
      ...
      setFormData({
        ...
        primary_phone_number: customer.primary_phone_number ? String(customer.primary_phone_number) : (customer.phone ? String(customer.phone) : ''),
        ssn: customer.ssn ? String(customer.ssn) : '',
        dob: customer.dob || '',
        address_line_1: customer.address_line_1 || customer.address || '',
        address_line_2: customer.address_line_2 || '',
        city: customer.city || '',
        state: customer.state || '',
        zip_code: customer.zip_code ? String(customer.zip_code) : '',
        customer_number: customer.customer_number ? String(customer.customer_number) : '',
        ...
        transfer_phone_number: customer.transfer_phone_number ? String(customer.transfer_phone_number) : '',
        transfer_ip_address: customer.transfer_ip_address || '',
        credit_score: customer.credit_score ? String(customer.credit_score) : '',
        monthly_income: customer.monthly_income ? String(customer.monthly_income) : '',
